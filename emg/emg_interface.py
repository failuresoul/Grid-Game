"""
emg/emg_interface.py — EMG (Electromyography) Hardware Interface
...
Isolation guarantee:
  This module is ONLY imported by main.py when config.EMG_ENABLED is True.
  The game package (game/*, ui/*, metrics/*) never imports from emg/.
  This prevents any EMG code from affecting the running game when hardware
  is unavailable.
"""
...
class EMGInterface:
    ...
    def __init__(
        ...
        log.info(
            "EMGInterface created (disabled stub). "
    ...
    def connect(self) -> bool:
        """Open the connection to the EMG device. Returns True on success."""
    ...
    def get_muscle_activation(self) -> float:
        """
        Normalised muscle-activation level in [0.0, 1.0].
    ...
    # TODO: log muscle activation alongside path-efficiency / NJS in sessions CSV
